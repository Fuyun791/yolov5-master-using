...
def parse_opt(known=False):
    ...
    parser.add_argument("--batch-size", type=int, default=-1, help="total batch size for all GPUs, -1 for autobatch default 16")
    ...
    parser.add_argument("--workers", type=int, default=4, help="default '8' max dataloader workers (per RANK in DDP mode)")
